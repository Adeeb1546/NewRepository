  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-sm-9">
        ...
        $sql1 = "SELECT * FROM `products` WHERE `product_id` = '$w_id' ";
          ...
          <div class="col-sm-4 col-md-6 mb-4">
            <div class="">
              <img class="card-img-top" style="width: 300px;
                    height: 312px" src="Admin/images/<?php echo $product_image;?>" alt="">
            </div>
      	  </div>
...
$u_id_cart = $row['user_id'];
 ...
 $sql ="UPDATE `products` SET`cart`= (1), `user_cart_id` = $u_id_cart WHERE product_id = $w_id ";
    ...
    $result = mysqli_query($conn, $sql);
    if($result){
      echo "      <meta http-equiv = \"refresh\" content = \"0; url = http://adeeb.cf/level1/cart/addtocart.php?c_id=$product_id\" />
...
$sql ="UPDATE `products` SET`wishlist`= (1), `user_cart_id` = $u_id_cart WHERE product_id = $w_id ";
    ...
    $result = mysqli_query($conn, $sql);
    if($result){
     echo "      <meta http-equiv = \"refresh\" content = \"0; url = http://adeeb.cf/level1/cart/addtowishlist.php?c_id=$product_id\" />
