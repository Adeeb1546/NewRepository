  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div>
        ...
        <div class="row">
<?php 
        $sql = "SELECT  * FROM  products WHERE product_category='Games' ORDER BY product_id DESC  ";
        ...
        ?>
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="../viewgames.php?w_id=<?php echo $product_id ?>"><img class="card-img-top" style="width: 200px;
