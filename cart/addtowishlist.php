  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <?php
         ...
         $sql = "UPDATE products SET `wishlist` = (0), `user_cart_id` = 0 WHERE product_id = '$del' ";
            $result = mysqli_query($conn,$sql);
                if($result){
                   
                 echo "      <meta http-equiv = \"refresh\" content = \"0; url = http://adeeb.cf/level1/cart/addtowishlist.php\" />";
                }else{
                    echo "fuck";
                }
                }
   ...
   <div class="card shopping-cart">
            ...
            <div class="card-body">
              <?php 
                ...
                $sql = "SELECT * FROM products WHERE wishlist = 1 AND user_cart_id = $u_id_cart";
                $result = mysqli_query($conn,$sql);
                if($result){
        ...
        <a type="submit" href="addtowishlist.php?carttt=<?php echo $product_id; ?>" name="carttt" class="btn btn-info  btn-lg" > Add to cart</a>
               <!--  -->
<?php 
/*//<a href="cart/addtocart.php?c_id=<?php echo $item_id  ?>">*/
    if(isset($_GET['carttt'])){
        $w_id = $_GET['carttt'];


  $sql ="UPDATE `products` SET`cart`= 1 ,`wishlist` = 0 , `user_cart_id` = $u_id_cart  WHERE product_id = $w_id ";

    $result = mysqli_query($conn, $sql);
    if($result){
       die("<meta http-equiv = \"refresh\" content = \"0; url = http://adeeb.cf/level1/cart/addtocart.php\" />");
 ...
 ?>
                        ...
                        <div class="col-12 col-sm-12 text-sm-center col-md-4 text-md-right row">
                            ...
                            <div class="col-2 col-sm-2 col-md-2 text-right">
                                <a type="submit" name="delete" href="addtowishlist.php?delete=<?php echo $product_id ?>"class="btn btn-outline-danger btn-xs">
